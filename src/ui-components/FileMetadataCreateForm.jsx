...
import { createFileMetadata } from "../../scr/graphql/mutations";
const client = generateClient();
export default function FileMetadataCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setProcessedDate(initialValues.processedDate);
    setApprovedDate(initialValues.approvedDate);
    setRejectedDate(initialValues.rejectedDate);
    setRejectionReason(initialValues.rejectionReason);
    setCreatedBy(initialValues.createdBy);
    setBoxUploaded(initialValues.boxUploaded);
    setBoxUploadedAt(initialValues.boxUploadedAt);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createFileMetadata.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FileMetadataCreateForm")}
      {...rest}
    >
      <TextField
        label="File name"
